# Generated by Django 4.0.8 on 2022-11-12 15:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tg_id', models.BigIntegerField(blank=True, db_index=True, null=True, unique=True, verbose_name='Telegram ID')),
                ...
                ('premium_status', models.CharField(choices=[('trial', 'Trial'), ('regular', 'Regular'), ('permanent', 'Permanent'), ('expired', 'Expired')], default='expired', max_length=55, verbose_name='Статус')),
                ('premium_expire', models.DateTimeField(blank=True, default='', verbose_name='Действует до')),
